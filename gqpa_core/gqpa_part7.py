"""
🚀 GQPA DIAMOND - CZĘŚĆ 7: URUCHOMIENIE TESTÓW
...
print("\n[4/7] Inicjalizacja GQPA Diamond Tests...")
gqpa = GQPADiamondTests(agent, adapter)
print("✅ GQPA tester gotowy")

print("\n" + "="*70)
print("ROZPOCZĘCIE TESTÓW GQPA DIAMOND")
print("="*70)

# TEST G: GENERALIZATION
print("\n[5/7] Running TEST G: GENERALIZATION...")
g_results = gqpa.test_generalization(n_cycles=50)

# TEST Q: QUALITY
print("\n[5/7] Running TEST Q: QUALITY...")
q_results = gqpa.test_quality(n_trials=20)

# TEST P: PERFORMANCE
print("\n[5/7] Running TEST P: PERFORMANCE...")
p_results = gqpa.test_performance(n_cycles=200)

# TEST A: ADAPTATION
print("\n[5/7] Running TEST A: ADAPTATION...")
a_results = gqpa.test_adaptation(n_tasks=5)
...
report = gqpa.generate_gqpa_report()

print("\n[7/7] Tworzenie wizualizacji...")
gqpa.plot_gqpa_results()
...
print("\n📚 Semantic Memory Analysis:")
semantic_stats = agent.memory.get_semantic_statistics()
...
print("\n" + "💎"*35)
print("GQPA DIAMOND - PODSUMOWANIE KOŃCOWE")
print("💎"*35 + "\n")

scores = report['gqpa_scores']
...
if len(agent.memory.semantic_memory) >= 50:
...
print("\n📁 FILES GENERATED:")
print("   1. gqpa_diamond_report.json")
print("   2. gqpa_diamond_results.png")

print("\n" + "="*70)
print("✅ GQPA DIAMOND TESTS COMPLETED SUCCESSFULLY!")
print("="*70)
...
def export_agent_state():
    ...
    state = {
        'final_state': agent.get_enhanced_state_summary(),
        'memory_stats': agent.memory.get_semantic_statistics(),

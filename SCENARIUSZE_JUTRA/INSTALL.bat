@echo off
REM 📦 SCENARIUSZE_JUTRA - Instalacja środowiska
echo.
echo ============================================================
echo 📦 SCENARIUSZE JUTRA - INSTALACJA ŚRODOWISKA
echo ============================================================
echo.
...
echo   python api_scenarios.py
echo   LUB z głównego folderu:
echo   python start_scenariusze_jutra.py
echo.
pause
